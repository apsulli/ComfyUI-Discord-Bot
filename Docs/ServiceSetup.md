...
Type=simple
User=pi
WorkingDirectory=/home/pi/ComfyUI-Discord-Bot
# Point to the python executable in your virtual environment
ExecStart=/home/pi/ComfyUI-Discord-Bot/venv/bin/python comfy_bot.py
Restart=always
RestartSec=5
# Optional: Load environment variables directly from a file
# EnvironmentFile=/home/pi/ComfyUI-Discord-Bot/.env
